...
class StartCommand extends Command
{
    ...
    public function handle(int $user_id): void
    {
        ...
        $message = 'Добро пожаловать в это всеобъемлющее руководство по управлению стрессом при совмещении
                    множества обязанностей. Этот курс поможет вам развить устойчивость и навыки эмоциональной
                    саморегуляции для успеха в требовательной академической и профессиональной среде.';
